 ...
 *在它使用的标记。
 *
 *这个主题，可在儿童与loop.php或重写
 *环的template.php，其中'模板'是循环中
 *要求的模板。例如，循环的index.php会
 *使用如果它存在，我们为与循环问：
 *的<code> get_template_part（'环'，'指数'）;</代码>
 *
 *@包WordPress的
 *@分装Twenty_Ten
 *@自二十十大1.0
...
<?php /* Display navigation to next/previous pages when applicable */ ?>
<?php if (  $wp_query->max_num_pages > 1 ) : ?>
<div class="p1"><?php if (function_exists('pagenavi')) { pagenavi(); } ?></div>
<?php endif; ?>
