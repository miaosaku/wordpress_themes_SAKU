...
function twentyten_comment( $comment, $args, $depth ) {
	...
	switch ( $comment->comment_type ) :
		case '' :
	?>
	<link href="/wordpress/wp-content/themes/twentyten/style.css" rel="stylesheet" type="text/css" />
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<div class="comment-meta commentmetadata"><a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
			...
			?>
		</div></div><!-- .comment-meta .commentmetadata -->
     ...
     if(empty($output)){
         ...
         if ($monthresults) {
             ...
             if ($postresults) {
                 ...
                 $output .= '<ul class="archives-list"><li><div class="archives-yearmonth">' . $text . ' &nbsp;(' . count($postresults) . '&nbsp;篇文章)</div><ul class="archives-monthlisting">' . "\n";
...
function insertFootNote($content) {
	if(is_single() || is_feed()) { //如果不想feed输出就去掉"|| is_feed()"
		...
		$content.= '<span style="font-weight:bold;text-shadow:0 1px 0 #ddd;">声明:</span> 本文采用 <a rel="nofollow" href="http://creativecommons.org/licenses/by-nc-nd/2.5/" title="署名-非商业性使用-相同方式共享">BY-NC-ND</a> 协议进行授权 | <a href="'.home_url().'">'.get_bloginfo('name').'</a>
		      <span class="shareblog">
      <span id="shareblog"> <a id="qqt" rel="nofollow" title="腾讯微博"></a> <a id="sina" rel="nofollow" title="新浪微博"></a> <a id="renren" rel="nofollow" title="人人网"></a> <a id="douban" rel="nofollow" title="豆瓣"></a> <a id="fanfou" rel="nofollow" title="饭否"></a> <a id="kaixin001" rel="nofollow" title="开心网"></a> <a id="buzz" rel="nofollow" title="Google Buzz"></a> <a id="twitter" rel="nofollow" title="twitter"></a> </span>
    </span>
		';
		$content.= '<br />转载请注明转自《<a rel="bookmark" title="' . $wzbt . '" href="' . $wzlj . '">' . $wzbt . '</a>》 | 欢迎订阅： <a href="'.get_bloginfo('rss2_url').'">'.get_bloginfo('name').'</a>';
		$content.= '</div>';
	}
	return $content;
}
